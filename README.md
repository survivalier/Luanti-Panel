...
Le support de langues actifs depuis la v3.
> [!NOTE]
> Les langues incluses par défaut sont le Français et l'Anglais<br/>
> Un model de traduction pour la v3 est disponnible<br/>
> [Model de traduction](TRANSLATE.md)
